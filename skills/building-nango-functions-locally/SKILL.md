...
description: Builds Nango Functions in a checked-out Zero YAML TypeScript project using local files, index.ts registration, nango dryrun, generated tests, and optional nango deploy via CLI. Use when creating, updating, validating, testing, or deploying Nango actions or syncs locally in a repo. Prefer this over building-nango-functions when local files, a Nango root, CLI dryrun, generated tests, or deploy workflow is involved.
---
