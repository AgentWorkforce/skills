...
| [writing-agent-personas](skills/writing-agent-personas/SKILL.md) | 1.0.0 | Production-correctness rules and traps for AgentWorkforce personas — integration scope mounting, sandbox modes, inputs, teams, delegation, and the relayfile writeback contract. |
