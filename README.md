...
| [using-agent-relay](skills/using-agent-relay/SKILL.md) | 1.3.1 | Participant-side MCP reference for a **registered** relay agent (spawned worker / registered lead): messaging, channels, threads, reactions, search, webhooks. Counterpart to `orchestrating-agent-relay`. |
